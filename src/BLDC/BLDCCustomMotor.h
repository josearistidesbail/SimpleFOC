#ifndef BLDCCustomMotor_h
#define BLDCCustomMotor_h
...
/**
 BLDC motor class
*/
class BLDCCustomMotor: public FOCMotor
{
  public:
    /**
     ...
     @param phi_pm motor flux linkage of the Permanent Magnets - [Wb]
     @param base_speed motor base speed (speed it can run with max voltage applied)
     */ 
    BLDCCustomMotor(int pp,  float R = NOT_SET, float KV = NOT_SET, float L = NOT_SET, float phi_pm = NOT_SET, float base_speed = NOT_SET);
